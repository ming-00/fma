...
def compute_features(tid):
    ...
    try:
        ...
        x, sr = librosa.load(filepath, sr=None, mono=True, res_type='kaiser_best')  # kaiser_fast
    ...
    try:
        ...
        # mfcc we use melspectrogram for non speech purposes
...
def main():
    ...
    nb_workers = int(1 * psutil.cpu_count())

    table = (
        # (5000, 1), (3000, 3), (2000, 5), (1000, 10), 
        (0, nb_workers),)
